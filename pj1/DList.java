...
public class DList {
  ...
  public void insertFront(Object item) {
    ...
    if(this.isEmpty()){
      ...
      this.head.next.prev = newNode(item, this.head, this.head.next);
  ...
  public void insertBack(Object item) {
    ...
    if(this.isEmpty()){
      ...
      this.head.prev.next = newNode(item, this.head.prev, this.head);
  ...
  public String toString() {
    ...
    int i = 1;
    while (current != head) {
      result = result + "No."+i+": "+current.item + "  ";
  ...
  // short green = 245;
  // short blue = 128;
  // Pixel p1 = new Pixel(red, green, blue);
  // System.out.println("*************Pixel is :"+p1+"***************");
  // testList.insertFront(p1);
