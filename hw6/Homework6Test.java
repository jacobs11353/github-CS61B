...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    //System.out.println("============= The SimpleBoard is : ============");
    //System.out.println("");
    //System.out.println(table);
    //System.out.println("");

    //System.out.println("and the number of entry in each bucket is: ");
    //System.out.println(table.toHashString());

    System.out.println("");
    System.out.println("");

    System.out.println("============= The histograph is : ============");
    System.out.println("");
    table.histograph();
    System.out.println("");
  }
