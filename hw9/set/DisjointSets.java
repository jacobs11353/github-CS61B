...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
  	//check whether root1 and root2 is the root of set
    if (array[root1] >= 0 || array[root2] >= 0){
      System.out.println("root1 or root2 are not roots of their respective set");
      return;
    }
   ...
   * @return [string version of disjointset]
 */
  ...
  public static void main(String[] args) {
    ...
    for (int k = 1; k < NumInSameSet; k *= 2) {
      for (int j = 0; j + k < NumElements; j += 2 * k) {
        ...
        s.union(set1, set2);
        //System.out.println("after union operation, the disjointset is : "+s);
      }
    }
